...
public class RegistroVenta
{
     ...
     */
    @ManyToOne
    @JoinColumn(name = "PRODUCTO_REFERENCIA", referencedColumnName = "REFERENCIA")
     ...
     */
    @ManyToOne
    @JoinColumn(name = "COMPRADOR_LOGIN", referencedColumnName = "LOGIN")
    private Usuario comprador;
    
    
    //private Mueble productoReferencia;
